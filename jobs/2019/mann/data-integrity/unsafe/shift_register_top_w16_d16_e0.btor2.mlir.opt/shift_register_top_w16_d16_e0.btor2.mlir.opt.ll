...
26:                                               ; preds = %268, %0
  %27 = phi i16 [ %69, %268 ], [ %1, %0 ]
  %28 = phi i5 [ %74, %268 ], [ %3, %0 ]
  %29 = phi i1 [ %81, %268 ], [ %5, %0 ]
  %30 = phi i1 [ %98, %268 ], [ %7, %0 ]
  %31 = phi i5 [ %103, %268 ], [ %9, %0 ]
  %32 = phi i16 [ %106, %268 ], [ %10, %0 ]
  %33 = phi i1 [ false, %268 ], [ true, %0 ]
  %34 = phi i16 [ %115, %268 ], [ %11, %0 ]
  %35 = phi i16 [ %124, %268 ], [ %12, %0 ]
  %36 = phi i16 [ %133, %268 ], [ %13, %0 ]
  %37 = phi i16 [ %142, %268 ], [ %14, %0 ]
  %38 = phi i16 [ %151, %268 ], [ %15, %0 ]
  %39 = phi i16 [ %157, %268 ], [ %16, %0 ]
  %40 = phi i16 [ %166, %268 ], [ %17, %0 ]
  %41 = phi i16 [ %175, %268 ], [ %18, %0 ]
  %42 = phi i16 [ %184, %268 ], [ %19, %0 ]
  %43 = phi i16 [ %193, %268 ], [ %20, %0 ]
  %44 = phi i16 [ %202, %268 ], [ %21, %0 ]
  %45 = phi i16 [ %211, %268 ], [ %22, %0 ]
  %46 = phi i16 [ %220, %268 ], [ %23, %0 ]
  %47 = phi i16 [ %229, %268 ], [ %24, %0 ]
  %48 = phi i16 [ %238, %268 ], [ %25, %0 ]
  ...
  %105 = select i1 %104, i16 %52, i16 %32, !dbg !90
  %106 = select i1 %68, i16 0, i16 %105, !dbg !91
  %107 = select i1 %50, i16 %35, i16 0, !dbg !92
  %108 = icmp eq i32 %55, 10, !dbg !93
  %109 = and i1 %59, %108, !dbg !94
  %110 = select i1 %109, i16 %52, i16 %107, !dbg !95
  %111 = icmp eq i5 %28, 10, !dbg !96
  %112 = and i1 %59, %111, !dbg !97
  %113 = or i1 %50, %112, !dbg !98
  %114 = select i1 %113, i16 %110, i16 %34, !dbg !99
  %115 = select i1 %68, i16 0, i16 %114, !dbg !100
  %116 = select i1 %50, i16 %36, i16 0, !dbg !101
  %117 = icmp eq i32 %55, 11, !dbg !102
  %118 = and i1 %59, %117, !dbg !103
  %119 = select i1 %118, i16 %52, i16 %116, !dbg !104
  %120 = icmp eq i5 %28, 11, !dbg !105
  %121 = and i1 %59, %120, !dbg !106
  %122 = or i1 %50, %121, !dbg !107
  %123 = select i1 %122, i16 %119, i16 %35, !dbg !108
  %124 = select i1 %68, i16 0, i16 %123, !dbg !109
  %125 = select i1 %50, i16 %37, i16 0, !dbg !110
  %126 = icmp eq i32 %55, 12, !dbg !111
  %127 = and i1 %59, %126, !dbg !112
  %128 = select i1 %127, i16 %52, i16 %125, !dbg !113
  %129 = icmp eq i5 %28, 12, !dbg !114
  %130 = and i1 %59, %129, !dbg !115
  %131 = or i1 %50, %130, !dbg !116
  %132 = select i1 %131, i16 %128, i16 %36, !dbg !117
  %133 = select i1 %68, i16 0, i16 %132, !dbg !118
  %134 = select i1 %50, i16 %38, i16 0, !dbg !119
  %135 = icmp eq i32 %55, 13, !dbg !120
  %136 = and i1 %59, %135, !dbg !121
  %137 = select i1 %136, i16 %52, i16 %134, !dbg !122
  %138 = icmp eq i5 %28, 13, !dbg !123
  %139 = and i1 %59, %138, !dbg !124
  %140 = or i1 %50, %139, !dbg !125
  %141 = select i1 %140, i16 %137, i16 %37, !dbg !126
  %142 = select i1 %68, i16 0, i16 %141, !dbg !127
  %143 = select i1 %50, i16 %39, i16 0, !dbg !128
  %144 = icmp eq i32 %55, 14, !dbg !129
  %145 = and i1 %59, %144, !dbg !130
  %146 = select i1 %145, i16 %52, i16 %143, !dbg !131
  %147 = icmp eq i5 %28, 14, !dbg !132
  %148 = and i1 %59, %147, !dbg !133
  %149 = or i1 %50, %148, !dbg !134
  %150 = select i1 %149, i16 %146, i16 %38, !dbg !135
  %151 = select i1 %68, i16 0, i16 %150, !dbg !136
  %152 = call i16 @nd_bv16(), !dbg !137
  %153 = icmp eq i5 %28, 15, !dbg !138
  %154 = and i1 %59, %153, !dbg !139
  %155 = or i1 %50, %154, !dbg !140
  %156 = select i1 %155, i16 %152, i16 %39, !dbg !141
  %157 = select i1 %68, i16 0, i16 %156, !dbg !142
  %158 = select i1 %50, i16 %41, i16 0, !dbg !143
  %159 = icmp eq i32 %55, 1, !dbg !144
  %160 = and i1 %59, %159, !dbg !145
  %161 = select i1 %160, i16 %52, i16 %158, !dbg !146
  %162 = icmp eq i5 %28, 1, !dbg !147
  %163 = and i1 %59, %162, !dbg !148
  %164 = or i1 %50, %163, !dbg !149
  %165 = select i1 %164, i16 %161, i16 %40, !dbg !150
  %166 = select i1 %68, i16 0, i16 %165, !dbg !151
  %167 = select i1 %50, i16 %42, i16 0, !dbg !152
  %168 = icmp eq i32 %55, 2, !dbg !153
  %169 = and i1 %59, %168, !dbg !154
  %170 = select i1 %169, i16 %52, i16 %167, !dbg !155
  %171 = icmp eq i5 %28, 2, !dbg !156
  %172 = and i1 %59, %171, !dbg !157
  %173 = or i1 %50, %172, !dbg !158
  %174 = select i1 %173, i16 %170, i16 %41, !dbg !159
  %175 = select i1 %68, i16 0, i16 %174, !dbg !160
  %176 = select i1 %50, i16 %43, i16 0, !dbg !161
  %177 = icmp eq i32 %55, 3, !dbg !162
  %178 = and i1 %59, %177, !dbg !163
  %179 = select i1 %178, i16 %52, i16 %176, !dbg !164
  %180 = icmp eq i5 %28, 3, !dbg !165
  %181 = and i1 %59, %180, !dbg !166
  %182 = or i1 %50, %181, !dbg !167
  %183 = select i1 %182, i16 %179, i16 %42, !dbg !168
  %184 = select i1 %68, i16 0, i16 %183, !dbg !169
  %185 = select i1 %50, i16 %44, i16 0, !dbg !170
  %186 = icmp eq i32 %55, 4, !dbg !171
  %187 = and i1 %59, %186, !dbg !172
  %188 = select i1 %187, i16 %52, i16 %185, !dbg !173
  %189 = icmp eq i5 %28, 4, !dbg !174
  %190 = and i1 %59, %189, !dbg !175
  %191 = or i1 %50, %190, !dbg !176
  %192 = select i1 %191, i16 %188, i16 %43, !dbg !177
  %193 = select i1 %68, i16 0, i16 %192, !dbg !178
  %194 = select i1 %50, i16 %45, i16 0, !dbg !179
  %195 = icmp eq i32 %55, 5, !dbg !180
  %196 = and i1 %59, %195, !dbg !181
  %197 = select i1 %196, i16 %52, i16 %194, !dbg !182
  %198 = icmp eq i5 %28, 5, !dbg !183
  %199 = and i1 %59, %198, !dbg !184
  %200 = or i1 %50, %199, !dbg !185
  %201 = select i1 %200, i16 %197, i16 %44, !dbg !186
  %202 = select i1 %68, i16 0, i16 %201, !dbg !187
  %203 = select i1 %50, i16 %46, i16 0, !dbg !188
  %204 = icmp eq i32 %55, 6, !dbg !189
  %205 = and i1 %59, %204, !dbg !190
  %206 = select i1 %205, i16 %52, i16 %203, !dbg !191
  %207 = icmp eq i5 %28, 6, !dbg !192
  %208 = and i1 %59, %207, !dbg !193
  %209 = or i1 %50, %208, !dbg !194
  %210 = select i1 %209, i16 %206, i16 %45, !dbg !195
  %211 = select i1 %68, i16 0, i16 %210, !dbg !196
  %212 = select i1 %50, i16 %47, i16 0, !dbg !197
  %213 = icmp eq i32 %55, 7, !dbg !198
  %214 = and i1 %59, %213, !dbg !199
  %215 = select i1 %214, i16 %52, i16 %212, !dbg !200
  %216 = icmp eq i5 %28, 7, !dbg !201
  %217 = and i1 %59, %216, !dbg !202
  %218 = or i1 %50, %217, !dbg !203
  %219 = select i1 %218, i16 %215, i16 %46, !dbg !204
  %220 = select i1 %68, i16 0, i16 %219, !dbg !205
  %221 = select i1 %50, i16 %48, i16 0, !dbg !206
  %222 = icmp eq i32 %55, 8, !dbg !207
  %223 = and i1 %59, %222, !dbg !208
  %224 = select i1 %223, i16 %52, i16 %221, !dbg !209
  %225 = icmp eq i5 %28, 8, !dbg !210
  %226 = and i1 %59, %225, !dbg !211
  %227 = or i1 %50, %226, !dbg !212
  %228 = select i1 %227, i16 %224, i16 %47, !dbg !213
  %229 = select i1 %68, i16 0, i16 %228, !dbg !214
  %230 = select i1 %50, i16 %34, i16 0, !dbg !215
  %231 = icmp eq i32 %55, 9, !dbg !216
  %232 = and i1 %59, %231, !dbg !217
  %233 = select i1 %232, i16 %52, i16 %230, !dbg !218
  %234 = icmp eq i5 %28, 9, !dbg !219
  %235 = and i1 %59, %234, !dbg !220
  %236 = or i1 %50, %235, !dbg !221
  %237 = select i1 %236, i16 %233, i16 %48, !dbg !222
  %238 = select i1 %68, i16 0, i16 %237, !dbg !223
