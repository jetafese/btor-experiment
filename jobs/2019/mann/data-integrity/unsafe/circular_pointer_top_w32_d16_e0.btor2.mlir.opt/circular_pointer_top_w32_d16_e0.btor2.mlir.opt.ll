...
31:                                               ; preds = %248, %0
  %32 = phi i32 [ %67, %248 ], [ %1, %0 ]
  %33 = phi i6 [ %75, %248 ], [ %3, %0 ]
  %34 = phi i32 [ %79, %248 ], [ %4, %0 ]
  %35 = phi i32 [ %83, %248 ], [ %5, %0 ]
  %36 = phi i32 [ %87, %248 ], [ %6, %0 ]
  %37 = phi i32 [ %91, %248 ], [ %7, %0 ]
  %38 = phi i32 [ %95, %248 ], [ %8, %0 ]
  %39 = phi i32 [ %99, %248 ], [ %9, %0 ]
  %40 = phi i32 [ %103, %248 ], [ %10, %0 ]
  %41 = phi i32 [ %107, %248 ], [ %11, %0 ]
  %42 = phi i32 [ %111, %248 ], [ %12, %0 ]
  %43 = phi i32 [ %115, %248 ], [ %13, %0 ]
  %44 = phi i32 [ %119, %248 ], [ %14, %0 ]
  %45 = phi i32 [ %123, %248 ], [ %15, %0 ]
  %46 = phi i32 [ %127, %248 ], [ %16, %0 ]
  %47 = phi i32 [ %131, %248 ], [ %17, %0 ]
  %48 = phi i32 [ %135, %248 ], [ %18, %0 ]
  %49 = phi i32 [ %141, %248 ], [ %19, %0 ]
  %50 = phi i6 [ %146, %248 ], [ %21, %0 ]
  %51 = phi i1 [ %153, %248 ], [ %23, %0 ]
  %52 = phi i1 [ %172, %248 ], [ %25, %0 ]
  %53 = phi i6 [ %177, %248 ], [ %27, %0 ]
  %54 = phi i32 [ %180, %248 ], [ %28, %0 ]
  ...
  %140 = select i1 %139, i32 %57, i32 %49, !dbg !122
  %141 = select i1 %66, i32 0, i32 %140, !dbg !123
  ...
  %179 = select i1 %178, i32 %57, i32 %54, !dbg !161
  %180 = select i1 %66, i32 0, i32 %179, !dbg !162
  ...
  %199 = call i32 @nd_bv32(), !dbg !184
  %200 = lshr i6 %33, 0, !dbg !185
  %201 = trunc i6 %200 to i5, !dbg !186
  %202 = icmp eq i5 %201, -16, !dbg !187
  %203 = select i1 %202, i32 %32, i32 %199, !dbg !188
  %204 = icmp eq i5 %201, 15, !dbg !189
  %205 = select i1 %204, i32 %34, i32 %203, !dbg !190
  %206 = icmp eq i5 %201, 14, !dbg !191
  %207 = select i1 %206, i32 %35, i32 %205, !dbg !192
  %208 = icmp eq i5 %201, 13, !dbg !193
  %209 = select i1 %208, i32 %36, i32 %207, !dbg !194
  %210 = icmp eq i5 %201, 12, !dbg !195
  %211 = select i1 %210, i32 %37, i32 %209, !dbg !196
  %212 = icmp eq i5 %201, 11, !dbg !197
  %213 = select i1 %212, i32 %38, i32 %211, !dbg !198
  %214 = icmp eq i5 %201, 10, !dbg !199
  %215 = select i1 %214, i32 %39, i32 %213, !dbg !200
  %216 = icmp eq i5 %201, 9, !dbg !201
  %217 = select i1 %216, i32 %40, i32 %215, !dbg !202
  %218 = icmp eq i5 %201, 8, !dbg !203
  %219 = select i1 %218, i32 %41, i32 %217, !dbg !204
  %220 = icmp eq i5 %201, 7, !dbg !205
  %221 = select i1 %220, i32 %42, i32 %219, !dbg !206
  %222 = icmp eq i5 %201, 6, !dbg !207
  %223 = select i1 %222, i32 %43, i32 %221, !dbg !208
  %224 = icmp eq i5 %201, 5, !dbg !209
  %225 = select i1 %224, i32 %44, i32 %223, !dbg !210
  %226 = icmp eq i5 %201, 4, !dbg !211
  %227 = select i1 %226, i32 %45, i32 %225, !dbg !212
  %228 = icmp eq i5 %201, 3, !dbg !213
  %229 = select i1 %228, i32 %46, i32 %227, !dbg !214
  %230 = icmp eq i5 %201, 2, !dbg !215
  %231 = select i1 %230, i32 %47, i32 %229, !dbg !216
  %232 = icmp eq i5 %201, 1, !dbg !217
  %233 = select i1 %232, i32 %48, i32 %231, !dbg !218
  %234 = bitcast i5 %201 to <5 x i1>, !dbg !219
  %235 = call i1 @llvm.vector.reduce.or.v5i1(<5 x i1> %234), !dbg !220
  %236 = xor i1 %235, true, !dbg !221
  %237 = select i1 %236, i32 %49, i32 %233, !dbg !222
  %238 = icmp eq i32 %54, %237, !dbg !223
...
!169 = !DILocation(line: 234, column: 5, scope: !8)
...
!175 = !DILocation(line: 246, column: 5, scope: !8)
...
!183 = !DILocation(line: 259, column: 5, scope: !8)
...
!207 = !DILocation(line: 295, column: 12, scope: !8)
...
!233 = !DILocation(line: 330, column: 5, scope: !8)
!234 = !DILocation(line: 332, column: 5, scope: !8)
!235 = !DILocation(line: 334, column: 5, scope: !8)
