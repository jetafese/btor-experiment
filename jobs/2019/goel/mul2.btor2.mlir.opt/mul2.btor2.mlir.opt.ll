...
1:                                                ; preds = %39, %0
  %2 = phi i128 [ %14, %39 ], [ 0, %0 ]
  %3 = phi i128 [ %20, %39 ], [ 0, %0 ]
  %4 = phi i64 [ %24, %39 ], [ 0, %0 ]
  %5 = phi i64 [ %28, %39 ], [ 0, %0 ]
  ...
  %14 = select i1 %13, i128 0, i128 %12, !dbg !13
  %15 = zext i64 %9 to i128, !dbg !14
  %16 = zext i64 %8 to i128, !dbg !15
  %17 = mul i128 %16, %15, !dbg !16
  %18 = or i1 %6, %7, !dbg !17
  %19 = select i1 %18, i128 %17, i128 %3, !dbg !18
  %20 = select i1 %13, i128 0, i128 %19, !dbg !19
  %21 = call i64 @nd_bv64(), !dbg !20
  %22 = call i1 @nd_bv1(), !dbg !21
  %23 = select i1 %22, i64 %21, i64 %4, !dbg !22
  %24 = select i1 %13, i64 0, i64 %23, !dbg !23
  %25 = call i64 @nd_bv64(), !dbg !24
  %26 = call i1 @nd_bv1(), !dbg !25
  %27 = select i1 %26, i64 %25, i64 %5, !dbg !26
  %28 = select i1 %13, i64 0, i64 %27, !dbg !27
  %29 = select i1 %13, i1 true, i1 %22, !dbg !28
  %30 = select i1 %13, i1 true, i1 %26, !dbg !29
  %31 = select i1 %22, i64 %21, i64 %8, !dbg !30
  %32 = select i1 %13, i64 0, i64 %31, !dbg !31
  %33 = select i1 %26, i64 %25, i64 %9, !dbg !32
  %34 = select i1 %13, i64 0, i64 %33, !dbg !33
  %35 = icmp eq i128 %2, %3, !dbg !34
...
40:                                               ; preds = %1
  call void @verifier_error(), !dbg !40
  unreachable, !dbg !41
}
...
!4 = !DIFile(filename: "btor2mlir-1/hwmcc20/btor2/bv/2019/goel/mul2.btor2.mlir.opt", directory: "/home/jetafese")
