...
1:                                                ; preds = %39, %0
  ...
  %14 = select i1 %13, i64 0, i64 %12, !dbg !13
  %15 = zext i32 %9 to i64, !dbg !14
  %16 = zext i32 %8 to i64, !dbg !15
  %17 = mul i64 %16, %15, !dbg !16
  %18 = or i1 %6, %7, !dbg !17
  %19 = select i1 %18, i64 %17, i64 %3, !dbg !18
  %20 = select i1 %13, i64 0, i64 %19, !dbg !19
  %21 = call i32 @nd_bv32(), !dbg !20
  %22 = call i1 @nd_bv1(), !dbg !21
  %23 = select i1 %22, i32 %21, i32 %4, !dbg !22
  %24 = select i1 %13, i32 0, i32 %23, !dbg !23
  %25 = call i32 @nd_bv32(), !dbg !24
  %26 = call i1 @nd_bv1(), !dbg !25
  %27 = select i1 %26, i32 %25, i32 %5, !dbg !26
  %28 = select i1 %13, i32 0, i32 %27, !dbg !27
  %29 = select i1 %13, i1 true, i1 %22, !dbg !28
  %30 = select i1 %13, i1 true, i1 %26, !dbg !29
  %31 = select i1 %22, i32 %21, i32 %8, !dbg !30
  %32 = select i1 %13, i32 0, i32 %31, !dbg !31
  %33 = select i1 %26, i32 %25, i32 %9, !dbg !32
  %34 = select i1 %13, i32 0, i32 %33, !dbg !33
  %35 = icmp eq i64 %2, %3, !dbg !34
...
!4 = !DIFile(filename: "btor2mlir-1/hwmcc20/btor2/bv/2019/goel/mul1.btor2.mlir.opt", directory: "/home/jetafese")
