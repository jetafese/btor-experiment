...
7:                                                ; preds = %161, %0
  %8 = phi i256 [ %30, %161 ], [ %1, %0 ]
  %9 = phi i1 [ %43, %161 ], [ false, %0 ]
  %10 = phi i1 [ %45, %161 ], [ %3, %0 ]
  %11 = phi i1 [ %52, %161 ], [ false, %0 ]
  %12 = phi i256 [ %57, %161 ], [ %4, %0 ]
  %13 = phi i1 [ %61, %161 ], [ false, %0 ]
  %14 = phi i1 [ %86, %161 ], [ false, %0 ]
  %15 = phi i1 [ %145, %161 ], [ %6, %0 ]
  ...
  %148 = or i1 %147, %49, !dbg !147
  %149 = and i1 %22, %148, !dbg !148
  %150 = select i1 %149, i256 %12, i256 %8, !dbg !149
  ...
  %154 = or i1 %48, %54, !dbg !153
  %155 = select i1 %154, i256 %153, i256 0, !dbg !154
  %156 = select i1 %154, i256 %8, i256 0, !dbg !155
  %157 = icmp eq i256 %156, %155, !dbg !156
  %158 = xor i1 %157, true, !dbg !157
  %159 = and i1 true, %158, !dbg !158
  %160 = xor i1 %159, true, !dbg !159
  br i1 %160, label %161, label %162, !dbg !160

161:                                              ; preds = %7
  br label %7, !dbg !161

162:                                              ; preds = %7
  call void @__VERIFIER_error(), !dbg !162
  unreachable, !dbg !163
}
...
!4 = !DIFile(filename: "for-klee-hwmcc20/btor2/bv/2019/goel/gen43.btor2.mlir.opt", directory: "/home/jetafese")
...
!160 = !DILocation(line: 199, column: 5, scope: !8)
!161 = !DILocation(line: 201, column: 5, scope: !8)
!162 = !DILocation(line: 203, column: 5, scope: !8)
!163 = !DILocation(line: 204, column: 5, scope: !8)
